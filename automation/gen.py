...
project_ideas = ["operating system", "programming language", "browser", "container", "version control system", "text editor", "walking robot", "http router", "boring task automator (robot or code)", "2d game engine"]
